...
Original file is located at
    https://colab.research.google.com/drive/1TOvs16QUS67_tVWYT0y-62MtFJwMqfh9
...
# test = pd.read_csv('C:/Users/Rasa/Desktop/test.csv.zip', parse_dates=['Dates'], index_col='Id')
...
# **LogisticRegression(penalty= 'l1', C= 1, solver= 'saga', multi_class= 'ovr')**
"""
...
"""# **LogisticRegression(penalty= 'l1', C= 1, solver='saga', multi_class='multinomial')**"""
...
"""# **LogisticRegression(penalty= 'l2', C= 1, solver= 'lbfgs', multi_class= 'ovr')**
...
"""# **RandomForestClassifier(n_estimators=1, criterion='gini', random_state=42)**"""
...
tree.plot_tree(randomForestClassifierModel.estimators_[0],
...
"""# **XGBClassifier(n_estimators=1, criterion='gini', random_state=42)**"""

XGBClassifierModel = XGBClassifier(n_estimators=1, criterion='gini', objective='multi:softmax', random_state=42)
...
XGBClassifierModelPredictPredict = XGBClassifierModel.predict(X_test)
